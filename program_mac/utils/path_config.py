...
def get_project_root():
    ...
    current_dir = get_current_dir()  # .../LiveRobot-local/program_mac/utils
    # Project root = directory containing "program_mac" and "Live2D" (LiveRobot-local)
    # From program_mac/utils -> go up to program_mac -> go up to project root = 2 levels
    if is_colab():
        ...
        # LiveRobot-local: program_mac/utils -> program_mac -> LiveRobot-local (2 levels up)
