...
On **macOS**, use the **`program_mac`** directory (this copy). On Windows, use **`program`** — same layout. Run from that app directory (same `utils/memory_db` as `main.py`). Example:
