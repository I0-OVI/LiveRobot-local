...
Requires `turboquant` (pip install turboquant) on CUDA hosts.

On macOS without CUDA, models load in float16 on Apple GPU (MPS) when available, else float32 on CPU.
"""
import json
import os
import queue
