...
The default model is downloaded from Hugging Face on first run (unless already cached). Hub weights are full precision (BF16/FP16); with a GPU the app loads them in **4-bit** using bitsandbytes at load time (including **`qwen3.5-4b`**).
...
|--------|----------|------------------------|
| `qwen3.5-4b` | [`Qwen/Qwen3.5-4B`](https://huggingface.co/Qwen/Qwen3.5-4B) | `program/utils/models/qwen3.5-4b` |
